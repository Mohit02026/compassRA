...
export default async function PortalLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{
      ...
      {/* ── Sticky glass header ── */}
      <PortalHeader initials={initials} signOutAction={signOutAction} />

      {/* ── Page content ── */}
      <main className="px-5 md:px-8" style={{ position: 'relative', zIndex: 1, maxWidth: 1200, margin: '0 auto', paddingTop: 36, paddingBottom: 80 }}>
        {children}
      </main>
    </div>
  )
